...
{
    public $page_title = '• Daily Totals Report';
    ...
    {
        $dailyTotals = Order::dailyTotals($this->selectedYear, $this->selectedMonth)->get();
        return view('livewire.reports.daily-totals-report',[
            'dailyTotals' => $dailyTotals
        ])->layout('layouts.app', ['page_title' => $this->page_title, 'dailyTotalsReport' => 'active']);
    }
}
