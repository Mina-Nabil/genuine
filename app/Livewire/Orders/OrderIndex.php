...
class OrderIndex extends Component
{
    ...
    {
        $orders = Order::search(searchText: $this->search, deliveryDates: $this->deliveryDate, status: $this->status, driverId: $this->driver?->id, zoneId: $this->zone?->id)->OpenOrders()->NotDebitOrders()
        ->sortByDeliveryDate()
        ->paginate(50);
