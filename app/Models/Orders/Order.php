...
class Order extends Model
{
    ...
    public function scopeWeeklyZoneReport($query, $year, $month, $searchText = null, $zoneIds = [])
    {
        $query
            ...
            ->selectRaw("
                CASE 
                    WHEN DAYOFMONTH(orders.delivery_date) BETWEEN 1 AND 7 THEN 1
                    WHEN DAYOFMONTH(orders.delivery_date) BETWEEN 8 AND 14 THEN 2
                    WHEN DAYOFMONTH(orders.delivery_date) BETWEEN 15 AND 21 THEN 3
                    WHEN DAYOFMONTH(orders.delivery_date) >= 22 THEN 4
                END as week
            ")
