                ...
                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 no-wrap">
                    <thead class="border-t border-slate-100 dark:border-slate-800 bg-slate-200 dark:bg-slate-700">
                        <tr>
                            ...
                            <th scope="col" class="table-th">Return</th>
                            <th scope="col" class="table-th">Salary</th>
                            <th scope="col" class="table-th">سلفه</th>
                            <th scope="col" class="table-th">X2</th>
                            <th scope="col" class="table-th">مشتريات</th>
                            <th scope="col" class="table-th">كارته</th>
                        </tr>
                    </thead>
