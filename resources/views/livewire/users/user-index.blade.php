                ...
                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                    <thead class="border-t border-slate-100 dark:border-slate-800 bg-slate-200 dark:bg-slate-700">
                        <tr>
                            ...
                            <th scope="col" class="table-th">ID number</th>
                            <th scope="col" class="table-th">Activated</th>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                            ...
                            <div class="p-6 space-y-4">
                                {{-- <div class="flex-none flex items-center justify-center">
                                    <div
                                        ...
                                        <img @if ($userImage) src="@if (!is_string($this->userImage)) {{ $userImage->temporaryUrl() }} @else {{ $this->userImage }} @endif"
                            ...
                            <div
                                ...
                                <button wire:click="EditUser" data-bs-dismiss="modal"
                                    ...
                                    <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]"
                                        wire:loading wire:target="EditUser"
                                        icon="line-md:loading-twotone-loop"></iconify-icon>
                                </button>
                            </div>
                        </div>
