                ...
                <div>
                    <div class="dropdown relative ">
                        ...
                        <ul class="dropdown-menu min-w-max absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none"
                            ...
                            dark:hover:text-white cusor-pointer" wire:click="openChangePass">
                    ...
                    <div class="flex-none">
                        <div class="md:h-[186px] md:w-[186px] h-[140px] w-[140px] md:ml-0 md:mr-0 ml-auto mr-auto md:mb-0 mb-4 rounded-full ring-4
                            ...
                            <img @if ($userImage) src="{{ $userImage->temporaryUrl() }}" @elseif ($OLDuserImage)
                                src="{{ $this->userImage }}" @else src="{{ asset('assets/images/users/user-1.png') }}"
                                @endif alt="" class="w-full h-full object-cover rounded-full">
                            @if (!$userImage)
                            <label for="userImage"
                            ...
                            <span wire:click="clearImage"
                                class="absolute right-2 h-8 w-8 bg-slate-50 text-slate-600 rounded-full shadow-sm flex flex-col items-center justify-center md:top-[140px] top-[100px] cursor-pointer">
                                <iconify-icon wire:loading.remove wire:target="userImage,clearImage" icon="mdi:remove">
                                </iconify-icon>
                                <iconify-icon wire:loading wire:target="userImage,clearImage"
                                    icon="svg-spinners:ring-resize"></iconify-icon>
                            </span>
                    ...
                    <ul class="list space-y-8">
                        ...
                        <li class="flex space-x-3 rtl:space-x-reverse">
                            ...
                            <div class="flex-1">
                                ...
                                <input type="text" class="form-control @error('firstName') !border-danger-500 @enderror"
                            ...
                            <div class="flex-1">
                                ...
                                <input type="text" class="form-control @error('lastName') !border-danger-500 @enderror"
                ...
                <div class="card-body p-6">
                    <ul class="list space-y-4">
                        ...
                        <div class="border-dashed border dropzone-container cursor-pointer mt-2"
                            ...
                            <p class="dropzone-para" wire:loading wire:target="uploadIDFile" style="font-size:20px">
                            ...
                            <input name="file" type="file" class="dropzone dropzone-input" wire:model="uploadIDFile" />
                        </div>
                        @endif
            ...
            <div class="card h-full">
                ...
                <div class="card-body p-6">
                    <ul class="list space-y-4">
                        ...
                        <div class="border-dashed border dropzone-container cursor-pointer mt-2"
                            style="border-color: #aeaeae">
                            <p class="dropzone-para" wire:loading wire:target="uploadLicFile" style="font-size:20px">
                                <iconify-icon icon="svg-spinners:tadpole"></iconify-icon>
                            </p>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="form-group">
                                <div class="input-area">
                                    ...
                                    @error('oldPass')
                                    <span class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message
                                        }}</span>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-area">
                                    ...
                                    <span class="font-Inter text-sm text-danger-500 pt-2 inline-block">Passwords do not
                                        match</span>
                                    @endif
