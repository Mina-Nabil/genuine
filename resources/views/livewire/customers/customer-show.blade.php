                ...
                <div class="md:flex-1 rounded-md overlay min-w-\[var\(500px\)\] sm:col-span-2"
                    ...
                    <div class="card-body flex flex-col justify-center bg-cover card p-4 mt-4">
                        <div class="card-text flex flex-col justify-between  menu-open">
                            ...
                            <p wire:click='openSetWeightTarget'
                                class="text-xs font-light text-slate-600 dark:text-slate-300 clickable-link">
                                Monthly weight target:
                                <b>{{ $customer->monthly_weight_target / 1000 }}<small>KG</small></b>
                            </p>
                            <br>
                            <div class="card mb-5">
                    ...
                    <div class="card mb-5">
                        <div class="card-body px-6 p-6">
                            <div class="flex justify-between">
                                ...
                                @can('update', $customer)
                                    <button wire:click='openEditNote' class="action-btn" type="button">
                                ...
                                <div class="from-group">
                                    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
                                        <div class="input-area">
                                            ...
                                            <input id="pet_years" type="number" placeholder="Type to search..."
                                                class="form-control @error('pet_years') !border-danger-500 @enderror"
                                                wire:model="pet_years">
                                            @error('pet_years')
                                                <span
                                                    class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message }}</span>
                                            @enderror
            ...
            <div class="modal-dialog relative w-auto pointer-events-none">
                <div
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center justify-end p-6 border-t border-slate-200 rounded-b">
                            <button wire:click="updateCustomerNote" data-bs-dismiss="modal"
                                class="btn inline-flex justify-center text-white bg-black-500">
                                <span wire:loading.remove wire:target="updateCustomerNote">Submit</span>
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]"
                                    wire:loading wire:target="updateCustomerNote"
                                    icon="line-md:loading-twotone-loop"></iconify-icon>
                            </button>
                        </div>
                    </div>
