            ...
            <div class="card-body rounded-md bg-white dark:bg-slate-800 shadow-base">
                <div class="items-center p-5">
                    <header
                        ...
                        @if ($invoice->remaining_to_pay > 0 || Gate::allows('updatePaymentDue', $invoice))
                            <div class="relative mt-2 ml-5">
                                <div class="dropdown relative">
                                    ...
                                    <ul class=" dropdown-menu min-w-[120px] absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none"
                                        ...
                                        @endif
                                        @can ('updatePaymentDue',$invoice)
                                            <li wire:click="openUpdateDue"
                                                class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:text-white hover:bg-slate-900 dark:hover:bg-slate-600 dark:hover:text-white cursor-pointer">
                                                Update Payment Due
                                            </li>
                                        @endCan
                                ...
                                @forelse ($rawMaterials as $rawMaterial)
                                    <div class="basicRadio">
                                        <label class="flex items-center cursor-pointer">
                                            ...
                                            <span
                                                class="text-secondary-500 text-sm leading-6 capitalize">{{ $rawMaterial->name }}
                                            </span>&nbsp; <small>({{ $rawMaterial->pivot->price }} EGP)</small>
                                        </label>
                                    </div>
                                @empty
                ...
                <div
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div
                            ...
                            <button wire:click="closeUpdateDue" type="button"
                                class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                                data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="input-area">
                                <label for="editedPaymentDue"
                                    class="block text-sm font-medium text-gray-700">Date</label>
                                <input wire:model='editedPaymentDue' type="date" name="editedPaymentDue"
                                  
                                    class="form-control @error('editedPaymentDue') !border-danger-500 @enderror">
                                @error('editedPaymentDue')
                                    <span class="font-Inter text-sm text-danger-500 pt-2 inline-block">
                                        {{ $message }}
                                    </span>
                                @enderror
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center justify-end p-6 border-t border-slate-200 rounded-b">
                            <button wire:click="updatePaymentDue" data-bs-dismiss="modal"
                                class="btn inline-flex justify-center text-white bg-slate-900">
                                <span wire:loading.remove wire:target="updatePaymentDue">Submit</span>
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]"
                                    wire:loading wire:target="updatePaymentDue"
                                    icon="line-md:loading-twotone-loop"></iconify-icon>
                            </button>
                        </div>
                    </div>
