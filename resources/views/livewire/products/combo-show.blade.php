                    ...
                    @foreach ($combo->products as $product)
                        <tr>
                            ...
                            <td class="table-td ">
                                ...
                                @can('update', $combo)
                                    <button wire:click='removeProduct({{ $product->id }})' wire:confirm='Are you sure you want to remove this product?' class="action-btn" type="button">
                            ...
                            <div class="from-group">
                                ...
                                @error('product_id')
                                    <span
                                        class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message }}</span>
                                @enderror
                                <small class="text-gray-500">*  If the product already exists, it will be updated automatically.</small>
                            </div>
                                ...
                                <div class="input-area">
                                    ...
                                    @error('productQuantity')
                                        <span
                                            class="font-Inter text-sm text-danger-500 pt-2 inline-block">{{ $message }}</span>
                                    @enderror
                                    <small class="text-gray-500">Enter the quantity of the product in this combo.</small>
                                </div>
                            </div>
