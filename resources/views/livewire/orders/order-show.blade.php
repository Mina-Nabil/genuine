                ...
                @if ($order->is_whatsapp_sent)
                    <span
                        class="badge bg-success-500 text-success-500 bg-opacity-30 capitalize rounded-3xl"><iconify-icon
                            ...
                            WhatsApp Message Sent &nbsp;<iconify-icon class="cursor-pointer" wire:click='toggleConfirmRemoveWAmsg' icon="material-symbols:close" width="15" height="15"></iconify-icon>
                        </span>
                @endif
            </div>
            ...
            @can('update', $order)
                <div class="dropdown relative">
                    ...
                    <ul
                        ...
                        @endif
                        @if ($order->driver)
                            <a wire:click='sendWhatsappMessage' href="{{ $order->generateWhatsAppMessage() }}" target="_blanck">
                                <li
                                    class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                            dark:hover:text-white cursor-pointer">
