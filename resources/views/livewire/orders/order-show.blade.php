                                                ...
                                                <div class="relative mt-2 ml-5">
                                                    <div class="dropdown relative">
                                                        ...
                                                        <ul class=" dropdown-menu min-w-[120px] absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700 shadow z-[2] float-left overflow-hidden list-none text-left rounded-lg mt-1 m-0 bg-clip-padding border-none"
                                                            ...
                                                            @endforeach
                                                            <li wire:click="openPartialPayment"
                                                                class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:text-white hover:bg-slate-900 dark:hover:bg-slate-600 dark:hover:text-white cursor-pointer">
                                                                Pay Amount
                                                            </li>
                                                        </ul>
                            ...
                            <div class="card-body flex flex-col justify-between border rounded-lg h-full menu-open p-0 mb-5 p-2 px-6 overflow-x-auto no-wrap"
                                ...
                                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                    <tbody class="bg-white dark:bg-slate-800 ">
                                        ...
                                        <tr>
                                            <td class=" text-xs text-slate-500 dark:text-slate-400">
                                                @can('updateDiscount', App\Models\Orders\Order::class)
                ...
                {{-- <div class="card mt-5">
                    <div class="card-body rounded-md bg-white dark:bg-slate-800 shadow-base">
                        <div class="items-center p-5">
                            <div class="input-area w-full">
                                <div class="flex justify-between">
                                    <label for="phone" class="form-label"><b>Creator</b></label>
                                        <button wire:click='openSetCreatorSection' class="action-btn" type="button">
                                            <iconify-icon icon="heroicons:pencil-square"></iconify-icon>
                                        </button>
                                </div>
                                    ...
                                    <p class="text-xs">
                                        <a class="clickable-link"
                                            href="{{ route('profile', $order->creator->id) }}">
                    ...
                    <div
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                            ...
                            <div
                                ...
                                <button wire:click="closeUpdateLocationUrl" type="button"
                                    class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                                    data-bs-dismiss="modal">
                                    <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <!-- Modal footer -->
                            <div class="flex items-center justify-end p-6 border-t border-slate-200 rounded-b">
                                <button wire:click="updateLocationUrl" data-bs-dismiss="modal"
                                    class="btn inline-flex justify-center text-white bg-black-500">
                                    <span wire:loading.remove wire:target="updateLocationUrl">Submit</span>
                                    <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]"
                                        wire:loading wire:target="updateLocationUrl"
                                        icon="line-md:loading-twotone-loop"></iconify-icon>
                                </button>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                            ...
                            <div
                                ...
                                <button wire:click="closeSetCreatorSection" type="button"
                                    class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                                    data-bs-dismiss="modal">
                                    <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="from-group">
                                    <div class="input-area">
                                        ...
                                        <select name="creator_id" id="creator_id"
                                            class="form-control w-full mt-2 @error('creator_id') !border-danger-500 @enderror"
                                            wire:model="creator_id" autocomplete="off">
                    ...
                    <div
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                            ...
                            <div
                                ...
                                <button wire:click="closeConfirmReschedule" type="button"
                                    class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                                    data-bs-dismiss="modal">
                                    <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div class="from-group">
                                    <div class="input-area">
                                        <label for="rescheduleDate" class="form-label">Delivery date</label>
                                        <input id="rescheduleDate" type="date"
                                            class="form-control @error('rescheduleDate') !border-danger-500 @enderror"
                                            wire:model="rescheduleDate" autocomplete="off">
                                    </div>
                            ...
                            <!-- Modal footer -->
                            <div class="flex items-center justify-end p-6 border-t border-slate-200 rounded-b">
                                <button wire:click="rescheduleOder" data-bs-dismiss="modal"
                                    class="btn inline-flex justify-center text-white bg-black-500">
                                    <span wire:loading.remove wire:target="rescheduleOder">Submit</span>
                                    <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]"
                                        wire:loading wire:target="rescheduleOder"
                                        icon="line-md:loading-twotone-loop"></iconify-icon>
                                </button>
                            </div>
                        </div>
                                        ...
                                        <select name="returnPaymentMehod" id="returnPaymentMehod"
                                            ...
                                            @foreach ($PAYMENT_METHODS as $PAYMENT_METHOD)
                                                <option value="{{ $PAYMENT_METHOD }}">
                                                    Returned {{ ucwords(str_replace('_', ' ', $PAYMENT_METHOD)) }}
                                                </option>
                                            @endforeach
                ...
                <div
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div
                            ...
                            <button wire:click="closeSetDriverSection" type="button"
                                class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                                data-bs-dismiss="modal">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                        ...
                        <div
                            ...
                            <button type="button"
                                class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-slate-600 dark:hover:text-white"
                                data-bs-dismiss="modal" wire:click="closePartialPayment">
                                <svg aria-hidden="true" class="w-5 h-5" fill="#ffffff" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                        ...
                        <div class="p-6 space-y-4">
                            <div class="mb-4">
                                <label for="partialPaymentAmount"
                                    class="form-label @error('partialPaymentAmount') !border-danger-500 @enderror">Payment
                                    Amount</label>
                                <input type="number" step="0.01" min="0.01"
                                    max="{{ $order->remaining_to_pay ?? 0 }}" class="form-control"
                                    id="partialPaymentAmount" wire:model="partialPaymentAmount">
                                @error('partialPaymentAmount')
                                    <span class="text-danger-500 text-xs block mt-2">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-4">
                                <label for="partialPaymentMethod"
                                    class="form-label @error('partialPaymentMethod') !border-danger-500 @enderror">Payment
                                    Method</label>
                                <select class="form-control" id="partialPaymentMethod"
                                    wire:model="partialPaymentMethod">
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center justify-end p-6 border-t border-slate-200 rounded-b">
                            <button wire:click="makePartialPayment" data-bs-dismiss="modal"
                                class="btn inline-flex justify-center text-white bg-black-500">
                                <span wire:loading.remove wire:target="makePartialPayment">Submit</span>
                                <iconify-icon class="text-xl spin-slow ltr:mr-2 rtl:ml-2 relative top-[1px]"
                                    wire:loading wire:target="makePartialPayment"
                                    icon="line-md:loading-twotone-loop"></iconify-icon>
                            </button>
                        </div>
                    </div>
